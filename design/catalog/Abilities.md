...
**Dardan's kit is the Nexus.** The four Nexus abilities are unlocked by chapter, not by level – the first arrives at Ch 08, long before the Master promotion – and they are **not equipped and take no Capacity** (a Base class holds 3 and Exchange would not fit). Full rules in [The Nexus](../mechanics/The-Nexus.md); every value in the [Balancing Guide → The Nexus](../Balancing-Guide.md#the-nexus). *Active (command)* below is the trigger defined there: it ends the unit's movement for the turn but leaves its action. All four are unusable on a map whose level box locks the band (band shown black).
...
| Nexus Mastery | 4 | Passive | Every Nexus cooldown is removed – Exchange and Earthbound – and the Exchange and Lifeline ranges grow at every affinity rank by the bonus in the [Balancing Guide → Nexus Mastery](../Balancing-Guide.md#nexus-mastery). Heartpulse stays once per chapter. Unlocked in **Part 08** (Ch 49–52); whether at a chapter or a level is open – see [The Nexus → Open decisions](../mechanics/The-Nexus.md#open-decisions). | Lord Kit: Dardan |
