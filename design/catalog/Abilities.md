...
| Nexus Mastery | 4 | Passive | Every Nexus cooldown is removed – Exchange and Earthbound – and the Exchange and Lifeline ranges grow at every support rank by the bonus in the [Balancing Guide → Nexus Mastery](../Balancing-Guide.md#nexus-mastery), not yet set. Heartpulse stays once per chapter. Unlocked in **Part 08** (Ch 49–52); whether at a chapter or a level is open – see [The Nexus → Open decisions](../mechanics/The-Nexus.md#open-decisions). | Lord Kit: Dardan |
