...
> **Related files:** [The Nexus](The-Nexus.md) · [Chain Attack](Chain-Attack.md) · [Beast Summon](Beast-Summon.md) · [Magic System → Die 9 Elemente](Magic-System.md#die-9-elemente) · [Balancing Guide → Affinity](../Balancing-Guide.md#affinity) · [Balancing Guide → The Nexus](../Balancing-Guide.md#the-nexus) · [Progression System](../Progression-System.md) · [Design Pillars](../Design-Pillars.md) · [Levels → Ch 06](../levels/README.md#part-01-path-of-liberation) · [Ch 06](../../story/chapters/Part-01-Path-Of-Liberation/Chapter-06-Heroes-Are-Made-By-The-Path-They-Choose.md) · [Ch 08](../../story/chapters/Part-01-Path-Of-Liberation/Chapter-08-The-Vigilant-Knights.md)
...
| Action | **Every point source costs an action or a risk.** A heal is the healer's action; a Shove out of danger is the shover's action; a map talk is the talker's action on a map where enemies are still standing; a shared kill means two units committed to one enemy; a chain attack needs three units in formation against a shielded enemy; Exchange and Lifeline cost Dardan his position, his cooldown or his HP ([The Nexus → Cost](The-Nexus.md#cost)). There is no source that costs nothing |
...
| **Nexus – Exchange** | Dardan ↔ the swapped ally | Each Exchange ([The Nexus → 2](The-Nexus.md#2--exchange)). Counted as Nexus, not additionally as *out of danger* |
| **Nexus – Lifeline** | Dardan ↔ the linked ally | Once per round in which Dardan actually carried a share of the ally's damage or took a status in its place ([The Nexus → 3](The-Nexus.md#3--lifeline)). Placing the line alone earns nothing – the band pays when it carries |
| **Nexus – Heartpulse** | Dardan ↔ every unit that recovered HP | Each unit that was healed by at least one point by the pulse ([The Nexus → 4](The-Nexus.md#4--heartpulse)). Units at full HP and units without a rank – which the pulse does not reach – earn nothing |
| **Map talk** | The two talkers | *→ 5* |
| **Heart-to-Heart** | The two | *→ 6* |

*Earthbound* earns nothing – it targets an enemy, and there is no bond with an enemy to feed.
...
- **The bond is the Nexus.** Dardan's affinity list is a tactical map: at S he reaches across a room, at D across a corridor. Building the bond over forty chapters is building the range the Dajjal fight is won with ([The Nexus → Strategic Depth](The-Nexus.md#strategic-depth)).
...
Every value lives in the [Balancing Guide → Affinity](../Balancing-Guide.md#affinity) and, for the Nexus tables, in [→ The Nexus](../Balancing-Guide.md#the-nexus). All of them are proposals until Dardan confirms them:
...
| Exchange range, Lifeline range, Heartpulse heal by rank | What the bond is worth to the Nexus ([The Nexus → Balancing Guidelines](The-Nexus.md#balancing-guidelines)) |
...
| -------- | ----------- |
| **[The Nexus](The-Nexus.md)** | The dependency in both directions. Exchange range, Lifeline range and Heartpulse strength read the affinity rank between Dardan and the unit (*Core Rules → 8*); Exchange, Lifeline and Heartpulse feed the same bond back (*→ 2*). Earthbound neither reads nor feeds. On a map whose level box locks the band (band black) no Nexus source exists, and the rest of Affinity is untouched. |
...
| **Level design** (`levelcraft`) | Each level document lists its map talks – the pairs, not the lines. Level 08 must place the hostage Elena within Dardan's Exchange range at rank B ([Balancing Guide → The Nexus](../Balancing-Guide.md#the-nexus)). Level 06 lists the first talks. |
...
| **Permadeath / Casual** (backlog) | In Classic a fallen unit's bonds are frozen: no points, no rank-ups, no Heart-to-Hearts, no bonus – and the chart keeps its links greyed at their last rank (proposal, *Open decisions → 5*). In Casual a retreated unit is back next chapter and nothing is lost. |
...
- **The Affinity Chart** – the main-menu web, XC1's model, in-game only:
  ...
  - A fallen unit stays on the chart with its links greyed (proposal, *Open decisions → 5*).
...
5. **A fallen unit's links stay on the chart, greyed, at their last rank.** The alternative removes them. Kept because the chart is the band, and the band remembers.
6. **Which unit carries which element** – not assigned here. Lorekeeper's follow-up on the story half of every playable sheet; the character template needs the field. Until assigned, the combat bonus cannot be computed for any pair – the system is specified, not filled.
...
**Cross-references:** [The Nexus](The-Nexus.md) · [Chain Attack](Chain-Attack.md) · [Beast Summon](Beast-Summon.md) · [Magic System](Magic-System.md) · [Balancing Guide](../Balancing-Guide.md) · [Progression System](../Progression-System.md) · [Design Pillars](../Design-Pillars.md) · [Abilities](../catalog/Abilities.md) · [Levels](../levels/README.md)
