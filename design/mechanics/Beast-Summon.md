...
| **[The Nexus](Nexus.md)** | **A beast cannot be exchanged, linked, healed by Heartpulse or sealed.** The Nexus is Dardan's bond with a person, and the beast is nobody's. The Nexus specification states the same from its side. |
